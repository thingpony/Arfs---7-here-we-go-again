...
/obj/machinery/casino_prize_dispenser/Initialize()
	...
	item_list["Gear"] = list(
		CASINO_PRIZE("Experimental Welder", /obj/item/weldingtool/abductor, 1, 500, "gear"),
	...
	item_list["Clothing"] = list(
		CASINO_PRIZE("Shark mask", /obj/item/clothing/mask/rat, 1, 250, "clothing"),
		CASINO_PRIZE("Pig mask", /obj/item/clothing/mask/rat/fox, 1, 250, "clothing"),
		CASINO_PRIZE("Luchador mask", /obj/item/clothing/mask/luchador, 1, 250, "clothing"),
		CASINO_PRIZE("Horse mask", /obj/item/clothing/mask/rat/bee, 1, 250, "clothing"),
		CASINO_PRIZE("Goblin mask", /obj/item/clothing/mask/rat/bear, 1, 250, "clothing"),
		CASINO_PRIZE("Fake moustache", /obj/item/clothing/mask/fakemoustache, 1, 250, "clothing"),
		CASINO_PRIZE("Dolphin mask", /obj/item/clothing/mask/rat/bat, 1, 250, "clothing"),
		CASINO_PRIZE("Demon mask", /obj/item/clothing/mask/rat/raven, 1, 250, "clothing"),
